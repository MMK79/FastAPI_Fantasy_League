...
# Enable Foreign Key relationships between tables
from sqlalchemy.orm import relationship

# Refers to database.py file with SQLAlchemy configuration.
from database import Base


class Player(Base):
    # magic command to tell SQLAlchemy which table is should refer
    # Benefit of ORM = Mapping the Python code automatically to the underlying database
    __tablename__ = "player"

    # Attributes name automatically match with the columns of database
    # primary_key provides several benefits, such as: query optimization, enforcing uniquness, enabling relationships between classes
    ...
    # With use of team_player association table
...
class Performance(Base):
    ...
    # back_populates enable two-way relationship between child (performance) and parent (player)
