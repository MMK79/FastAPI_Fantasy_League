...
GET_COUNTS_ENDPOINTS = "/v0/counts/"

# get a reference to the log file
logger = logging.getLogger(__name__)


# decorator which add backoff and retry functionality to the call_api_endpoint
...
def call_api_endpoint(
    base_url: str, api_endpoint: str, api_params: Optional[dict] = None
) -> httpx.Response:
    try:
        # use httpx as a resource manager
